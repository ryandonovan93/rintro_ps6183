...
First let's have a look at the sleep data set by writing the following code in the R script.
...
#To run scripts in R, select the code you have written and click the Run button with the green arrow in the top right corner of the script. 

```

The `print()` function can be used to print out a data set in the console. There are also other ways to view a data set, such as using the functions `head()`, `tail()` `View()`, and `str()`. Type these in the console (make sure to put `sleep` inside the brackets) and see what results you get.
