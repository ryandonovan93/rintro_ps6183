...
df_raw <- read.csv("datasets/raw_remote_associations.csv") #make sure you have this in your working directory
...
#how can we remove these 3 participants? Well we can use multiple conditions and combine it with the OR operator - "|"
