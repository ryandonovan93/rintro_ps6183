...
\caption{\label{fig:unnamed-chunk-10}New Project Set Up}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{rintro_demo_files/figure-latex/unnamed-chunk-20-1.pdf}
\caption{\label{fig:unnamed-chunk-20}Generic Boxplot}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{rintro_demo_files/figure-latex/unnamed-chunk-21-1.pdf}
\caption{\label{fig:unnamed-chunk-21}Generic Boxplot with appropriate labelling}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-23}Four Examples of Comments Use}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-63}Indexing for Numeric Vector}
\end{figure}

\begin{figure}
\centering
\includegraphics{img/03-index-character.png}
\caption{\label{fig:unnamed-chunk-64}Indexing for Character Vector}
\end{figure}

\begin{figure}
\centering
\includegraphics{img/03-index-logical.png}
\caption{\label{fig:unnamed-chunk-65}Indexing for Logical Vector}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-79}The relationship between data frames and vectors. The different colours in the data frame indicate they are composed of independent vectors}
\end{figure}
