...
So we've talked about the different types of data that we experience in the world and how R classifies them. But in data analysis, we rarely ever just work individual pieces of data, one at a time. For example, we will often put
